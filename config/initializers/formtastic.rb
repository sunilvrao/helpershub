...
#
#
COUNTRIES = ["United States","India","Afghanistan", "Aland Islands", "Albania", "Algeria", "American Samoa", "Andorra", "Angola",
      ...
      "Yemen", "Zambia", "Zimbabwe"] unless Kernel.const_defined?("COUNTRIES")
